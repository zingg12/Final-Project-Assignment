...
<body>
  <div class="container my-5">
    ...
    <h1 class="text-center font-semibold blue-theme">Product</h1>
    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td>
              <a class="btn button-theme text-light font-medium" href="edit_product.php?id=<?php echo $row['id']; ?>">Edit</a> |
              <a class="btn button-theme2 blue-theme font-medium" href="delete_product.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
