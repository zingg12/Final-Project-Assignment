...
<body>
  <div class="container my-5">
    ...
    <h1 class="text-center font-semibold blue-theme">Materials</h1>
    <div class="text-center py-3">
      <a href="tambah_material.php" type="button" class="btn button-theme text-light font-regular">+ &nbsp; Add Material</a>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a class="btn button-theme text-light font-medium" href="edit_material.php?id=<?php echo $row['id_material']; ?>">Edit</a> |
              <a class="btn button-theme2 blue-theme font-medium" href="delete_material.php?id=<?php echo $row['id_material']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
            </td>
          </tr>
