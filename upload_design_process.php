...
include 'conn.php';
  ...
  $id = $_POST['id'];
  $gambar_material = $_FILES['desain']['name'];
    ...
    $nama_gambar_baru = $gambar_material; //menggabungkan angka acak dengan nama file sebenarnya
          if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                  move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                    ...
                    $query = "UPDATE shopping_cart SET desain = '$nama_gambar_baru'";
      ...
      $query  = "INSERT INTO shopping_cart (desain) VALUE '$nama_gambar_baru'";
                    $query .= "WHERE id = '$id'";
      $result = mysqli_query($conn, $query);
      // periska query apakah ada error
      if(!$result){
        ...
        //tampil alert dan akan redirect ke halaman index.php
        //silahkan ganti index.php sesuai halaman yang akan dituju
          echo "<script>alert('Kontol.');window.location='profile.php';</script>";
      }
    }