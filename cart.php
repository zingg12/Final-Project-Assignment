...
<body>
    ...
    <div class="container">
        <h1 class="h2 mt-3">Shopping Cart</h1>
        ...
        <div class="table-responsive mt-4" style="min-height: 300px;">
            <table class="table table-hover">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><?= $row['quantity']; ?></td>
                        <td class="font-weight-bold">Rp. <?= $row['harga_jual']; ?></td>
                        <td>
                            ...
                            <a class="btn btn-sm btn-danger font-regular" href="crud_cart.php?action=delete&id=<?= $row['id']; ?>" onclick="return confirm('Are you sure want to delete this record?')">
                    ...
                    <form action='cart_process.php' method="post">
                        ...
                        <input type="text" hidden readonly class="form-control" id="fname" name="fname" value="<?php echo $row['fname']; ?>">
                        <input type="text" hidden readonly class="form-control" id="lname" name="lname" value="<?php echo $row['lname']; ?>">
                        <input type="text" hidden readonly class="form-control" id="phone" name="phone" value="<?php echo $row['phone']; ?>">
                        <input type="text" hidden readonly class="form-control" id="confirm" name="confirm" value="<?php echo $row['confirm']; ?>">
                        <input type="text" hidden readonly class="form-control" id="address" name="address" value="<?php echo $row['address']; ?>">
                        <input type="text" hidden readonly class="form-control" id="email" name="email" value="<?php echo $row2['email']; ?>">
                        <input type="text" hidden readonly class="form-control" id="user_id" name="user_id" value="<?php echo $row['user_id']; ?>">
            ...
            <div class="container d-flex justify-content-between py-5">
                <div>
                    <img src="assets/Digitalie.svg" alt=""> <br>
                    <a href="products.php" type="button" class="btn btn-primary font-regular btn-block button-theme2 mt-4">View Products</a>
                </div>
                <div>
                    <button class="btn btn-lg btn-primary btn-block" id="button-proceed" type="submit">Checkout</button>
                    <p class="d-block w-50 mt-3">Please take a note that after you do checkout for your shopping cart, the quotation will be made and can not be undone.</p>
                </div>
            </div>
            <!-- <button type="submit" class="btn w-100 btn-primary button-theme font-regular btn-grid">Proceed</button> -->
            </form>
        </div>
    </div>
