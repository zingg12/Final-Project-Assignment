    ...
    <div class="container py-5">
        <div class="row d-flex justify-content-center">
            <div class="col-md-9 col-lg-7 col-xl-5">
                <div class="card">
                    <img src="assets/Digitalie.svg" width="10" class="card-img-top rounded-3" />
                    <div class="card-body">
                        <div class="font-semibold text-center mt-2" style="font-size: 18px;">Thank you for ordering at Digitalie!
                            <p class="my-4 font-regular" style="font-size: 14px;">Please kindly recheck and choose a payment to confirm your order.</p>
                        </div>
                        <div class="card-title d-flex justify-content-between mb-0">

                            <p class="mb-0 font-regular">Order ID : <?php echo $row3['cart_id']; ?></p>
                            <p class=" mb-0 font-regular">Total : Rp<?php echo $row3['total']; ?></p>
                        </div>
                    </div>
                    <div class="rounded-bottom" style="background-color: #eee;">
                        <div class="card-body">
                            <p class="mb-4 font-medium">Your payment details</p>

                            <div class="form-outline mb-3">
                                <input type="text" id="formControlLgXM8" class="form-control font-regular mb-2" placeholder="Your name" value="<?php echo $row['fname']; ?> <?php echo $row['lname']; ?>" />
                                <label class="form-label font-regular" for="formControlLgXM8">On behalf of</label>
                            </div>

                            <div class="row mb-3">
                                <div class="col-6">
                                    <!-- <div class="form-outline">
                                        <input type="password" id="formControlLgExpk8" class="form-control" placeholder="MM/YYYY" />
                                        <label class="form-label" for="formControlLgExpk8">Expire</label>
                                    </div> -->
                                    <img src="assets/bca.jpg" width="200px" alt="BCA">
                                    <!-- <img src="assets/bri.png" width="100px" alt=""> -->
                                </div>
                                <div class="col-6">
                                    <div class="form-outline">
                                        <input type="text" readonly id="formControlLgcvv8" class="form-control mb-2" placeholder="Nomor Rekening" value="1234 567 869" />
                                        <!-- <label class="form-label" for="formControlLgcvv8"></label> -->
                                        <div class="form-text">Please transfer to this account number on behalf of Yudi Lie, with the total price charged.</div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-grid gap-2 mt-4">
                                <a href="profile.php" type="button" class="btn button-theme text-light font-regular btn-block">Check your orders</a>
                                <a href="products.php" type="button" class="btn button-theme2 font-regular btn-block">Back to catalogue</a>
                            </div>
                        </div>
                    </div>
                </div>
